...
"""
 ...
 Data..........: 09/04/2021
 Descrizione...: Esporta in un database sqlite una tabella di un database oracle
"""
...
class import_export_oracle_to_sqlite_class(FlaskForm):
    """
    ...
    e_from_oracle_table = TextField('Oracle source table') 
...
def copy_table_oracle_to_sqlite(v_user_db,
    ...
    if v_posizioni_blob:     
        ...
        # Se la cartella esiste già errore ed esco
            ...
            if v_overwrite:                
                delete_files_in_dir(v_blob_pathname + '\\' + v_table_name)                        
